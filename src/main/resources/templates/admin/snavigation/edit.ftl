...
<#if snavigation.id>0 >
<input type="hidden" name="id" value="${snavigation.id} ">
</#if>

  <div class="form-group">
    <label for="inputName" class="col-sm-2 control-label">导航名称</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" value="${snavigation.name }" name="name"  id="inputName" placeholder="导航名称">
    </div>
  </div>
  <div class="form-group">
    <label for="inputAddress" class="col-sm-2 control-label">导航地址</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputAddress" value="${snavigation.address }" name="address" placeholder="导航地址">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="sort" value="${snavigation.sort}" id="inputSort" placeholder="导航sort">
    </div>
  </div>
